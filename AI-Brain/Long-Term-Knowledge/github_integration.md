...
**Repository:** `davidtres03/Catalyst-Personal`  
**URL:** `https://github.com/davidtres03/Catalyst-Personal`  
...
$releases = Invoke-RestMethod -Uri "https://api.github.com/repos/davidtres03/Catalyst-Personal/releases" -Headers $headers
...
Invoke-RestMethod -Uri "https://api.github.com/repos/davidtres03/Catalyst-Personal/releases" -Method Post -Headers $headers -Body $body -ContentType "application/json"
```
